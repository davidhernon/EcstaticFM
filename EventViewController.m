...
- (void)viewDidLoad
{
    ...
    [playerView initializeAudio];
    [playerView stream:streamURL];
    //[self getPlayer];
...
//- (void)getPlayer
//{
//    PlayerView *playerView = [[PlayerView alloc] initWithFrame:CGRectMake(0, 350,650, 350)];
//    playerView.backgroundColor = [Utils colorWithHexString:@"0EA48B"];
//    playerView.userInteractionEnabled = YES;
////    [self->volumeView addSubview:playerView];
//}
//
//
