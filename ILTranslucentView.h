...
@property (nonatomic, weak) IBOutlet UITextField *soundcloud_search;
@property (nonatomic, weak) IBOutlet UIButton *search;
@property soundCloudMediaPickerViewController *sender;

-(void)addSender:(soundCloudMediaPickerViewController*)scmp;
