...
// GRUnit
#define COCOAPODS_POD_AVAILABLE_GRUnit
#define COCOAPODS_VERSION_MAJOR_GRUnit 1
#define COCOAPODS_VERSION_MINOR_GRUnit 1
#define COCOAPODS_VERSION_PATCH_GRUnit 3
